...
//   ol.id = "write";
//   ol.className = "container mt-5";
//   write.appendChild(ol)
...
// // Fill form for editing (not triggered in current flow but included)
// function fillForm(data) {
//   form.email.value = data.email;
//   form.firstName.value = data.firstName;
//   form.lastName.value = data.lastName;
...
// // Utility: get value by matching label
// function getByLabel(labelText) {
//   const label = Array.from(form.querySelectorAll('label'))
//     .find(l => l.textContent.includes(labelText));
//   return label?.nextElementSibling?.valueAsNumber || null;
...
// // Utility: set value by matching label
// function setByLabel(labelText, value) {
//   const label = Array.from(form.querySelectorAll('label'))
//     .find(l => l.textContent.includes(labelText));
//   if (label?.nextElementSibling) {
...
// Fill form for editing (can be wired to an "Edit" button if needed)
function fillForm(data) {
  form.email.value = data.email;
  form.firstName.value = data.firstName;
  form.lastName.value = data.lastName;
